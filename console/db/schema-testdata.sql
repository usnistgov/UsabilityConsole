...
INSERT INTO users (role_id, username, password, first_name, last_name, api_key) VALUES (1, 'kmangold', 'p4ssw0rd', 'Kevin', 'Mangold', "asdf1234");      -- user_id: 2
INSERT INTO users (role_id, username, password, first_name, last_name, api_key) VALUES (2, 'testuser', 'p4ssw0rd', 'Test', 'User', 'qwerty12345678');          -- user_id: 3
INSERT INTO users (role_id, username, password, first_name, last_name, api_key) VALUES (1, 'js1', 'p4ssw0rd', 'John', 'Smith', 'qwerty12345678');              -- user_id: 4
INSERT INTO users (role_id, username, password, first_name, last_name) VALUES (2, 'alice', 'p4ssw0rd', 'Alice', 'Cooper');          -- user_id: 5
INSERT INTO users (role_id, username, password, first_name, last_name) VALUES (2, 'rmcdonald', 'p4ssw0rd', 'Ronald', 'McDonald');   -- user_id: 6
...
INSERT INTO sessions (creator_id, name) VALUES (5, "Alice's Study - P314");     -- session_id: 2
